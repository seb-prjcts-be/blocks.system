...
`v0.4.2` is de huidige onveranderlijke publieke release. Op de releasecommit
...
- ESM: `https://cdn.jsdelivr.net/gh/seb-prjcts-be/blocks.system@v0.4.2/blocks.system.mjs`
- CSS: `https://cdn.jsdelivr.net/gh/seb-prjcts-be/blocks.system@v0.4.2/blocks.system.css`

De releasegrenscorrectie staat in [`releases/v0.4.2.md`](releases/v0.4.2.md),
de documentatiefixes staan in [`releases/v0.4.1.md`](releases/v0.4.1.md) en de
...
worden; `stableRef` blijft dan `v0.4.2`.
