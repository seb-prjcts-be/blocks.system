...
assert.match(manualHtml, /shell\.mjs\?v=0\.1\.25[\s\S]*manual\.mjs\?v=0\.1\.35/, "the manual must load the separated variant, color and chance lessons without stale module caches");
