...
assert.match(manualHtml, /shell\.mjs\?v=0\.1\.31[\s\S]*manual\.mjs\?v=0\.1\.41/, "the manual must load the compact, variant, color and chance lessons without stale module caches");
